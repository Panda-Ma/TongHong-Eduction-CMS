<template>
  <div class="edit-student-container">
    <el-dialog title="修改学生" v-model="isShowDialog" width="769px" @close="resetData">
          ...
          <el-col :span="12">
            <el-col class="mb20" :span="18">
              <el-form-item label="姓名" prop="studentName">
                <el-input v-model="data.studentName" placeholder="请输入学生姓名" clearable></el-input>
              </el-form-item>
            </el-col>
            <el-col class="mb20" :span="18">
...
import {Student, StudentDialog} from "/@/views/student/interface";
...
export default defineComponent({
  ...
  setup: function (_, {emit}) {
    ...
    const state = reactive<StudentDialog>({
      isShowDialog: false,
      data: {
        id: -1,
        studentName: '',
